...
if ( ! function_exists( 'ds_skoda_setup' ) ) :
	...
	function ds_skoda_setup() {
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'ds-skoda' ),
		) );
...
function ds_skoda_scripts() {
	...
	wp_enqueue_script( 'ds-skoda-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'ds-skoda-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
